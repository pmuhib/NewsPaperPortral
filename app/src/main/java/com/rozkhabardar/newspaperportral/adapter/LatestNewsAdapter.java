...
public class LatestNewsAdapter extends RecyclerView.Adapter<LatestNewsAdapter.Viewholder> {
    ...
    public LatestNewsAdapter(Context context, ArrayList<Items> feeditemsList, String name) {
...
/*        if(name.equalsIgnoreCase("JobFeeds"))
        ...
        holder.btshare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                circleMenu.setMainMenu(Color.parseColor("#CDCDCD"), R.drawable.plus, R.drawable.cross)
                        .addSubMenu(Color.parseColor("#25bcff"), R.drawable.ic_whatsapp)
                        .addSubMenu(Color.parseColor("#25bcff"), R.drawable.ic_twitter)
    ...
    public void submit(MyAdapter.Clickable clickable) {
